...
/// I implement IInteractable (for interaction wheel), IIconItem (inventory icon), and ISaveLoadableObject (stub for Phase G).
///
...
public class BaseHeldTool : BaseSellableItem, IInteractable, ISaveLoadableObject, IIconItem
{
	...
	public PlayerMovement GetOwner() => owner;
	public void SetOwner(PlayerMovement val) => owner = val;
	#endregion
